...
parser.add_argument('--img_path', type=str, default='./data/test_img/20439171_260546633.jpg', help='the path of the input image to network')
...
# load alphabet
with open('./data/char_std_5990.txt', encoding="utf8") as f:
    data = f.readlines()
